...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Nov 22, 2024 at 03:05 AM
...
CREATE TABLE `booking` (
  ...
  `Booking_extras` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `booking_review` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL
...
INSERT INTO `booking` (`bookingID`, `roomID`, `customerID`, `checkin_date`, `checkout_date`, `contact_number`, `Booking_extras`, `booking_review`) VALUES
(1, 1, 1, '2024-11-21', '2024-11-23', '123-123-1234', '', '');
...
(21, 'ab', 'cd', 'abcd@gmail.com', 'abcd1234');
